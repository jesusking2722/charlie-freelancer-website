const AIExpertHiringBenefitsFaq = () => {
  return (
    <div className="w-full">
      ...
      <div className="w-full mt-14">
        <p>
          ...
          some key advantages for businesses looking to find talent on Charlie
          Unicorn AI - Freelancer.
        </p>
        <ul className="list-disc p-4 px-12">
          <li>
...
export default AIExpertHiringBenefitsFaq;
